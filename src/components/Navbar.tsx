...
const Navbar = () => {
  ...
  return <nav className="fixed w-full bg-white/80 backdrop-blur-md z-50 py-4">
      <div className="container mx-auto px-4">
        ...
        {/* Mobile Menu */}
        {isOpen && <div className="md:hidden absolute top-full left-0 w-full bg-white py-4 px-4 shadow-lg">
